...
titlelabel=Label(titleframe,text="AVC COLLEGE",bg="sky blue",fg="green",font=titlefont)
titlelabel.place(relx=0.5,rely=0.35)
titleframe.pack()
mainframe=Frame(root,width=500,height=450,bg="pink")
alable=Label(mainframe,text=" (i) enter the email id :",bg="pink",font=labelfont).place(relx=0.002,rely=0.25)
aentry=Entry(mainframe,font=labelfont)
aentry.place(relx=0.43,rely=0.26)
blable=Label(mainframe,text=" (ii) enter the password : ",bg="pink",font=labelfont).place(relx=0.002,rely=0.39)
bentry=Entry(mainframe,font=labelfont)
bentry.place(relx=0.43,rely=0.4)
clable=Label(mainframe,text=" (iii) Application no  :",bg="pink",font=labelfont).place(relx=0.002,rely=0.53)
centry=Entry(mainframe,font=labelfont)
centry.place(relx=0.4,rely=0.53)
clable=Label(mainframe,text=" (iv) enter the upi id :",bg="pink",font=labelfont).place(relx=0.002,rely=0.67)
centry=Entry(mainframe,font=labelfont)
centry.place(relx=0.4,rely=0.67)
b=Button(mainframe,text="Pay Now")
...
b=Button(sideframe,text="History")
b.place(relx=0.1,rely=0.2)
b=Button(sideframe,text="Details")
b.place(relx=0.1,rely=0.3)
b=Button(sideframe,text="Help")
b.place(relx=0.1,rely=0.4)
b=Button(sideframe,text="Another way")
